...
- [x] T017 [US2] Handoff lifecycle helpers: handoff path naming (`handoff-<pid>-<id>`), stale-handoff cleanup at startup + unit tests — 2026-07-05: done via haiku-implementer; 4 tests green.
